...
contract('AcroActors', async accounts => {
    ...
    it("calculate the right voting coefficient according to staking balance", async() => {
        ...
        await acroInstance.buy_acro({from: user1, value:web3.utils.toWei('0.01', "ether")}); //buying 13 Acro
    ...
    it("A validated actor can vote for another registered actor", async() => {
        ...
        await acroInstance.buy_acro({from: owner, value:web3.utils.toWei('0.01', "ether")}); //buying 13 acros
    ...
    it("A non-validated actor cannot vote", async() => {
        ...
        await acroInstance.buy_acro({from: user1, value:web3.utils.toWei('0.01', "ether")});
        let stakeAmount = new BN(10);
    ...
    // // To run this test below, the voting coefficient in the fonction votingCoefficient must be set to 10.
